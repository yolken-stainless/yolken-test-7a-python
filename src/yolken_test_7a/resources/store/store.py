...
class StoreResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> StoreResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/yolken-test-7a-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> StoreResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/yolken-test-7a-python#with_streaming_response
        """
