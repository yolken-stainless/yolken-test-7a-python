...
from ._exceptions import APIStatusError, YolkenTest7aError
...
class YolkenTest7a(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous YolkenTest7a client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("YOLKEN_TEST_7A_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> YolkenTest7aWithRawResponse:
        return YolkenTest7aWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> YolkenTest7aWithStreamedResponse:
        return YolkenTest7aWithStreamedResponse(self)
...
class AsyncYolkenTest7a(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncYolkenTest7a client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncYolkenTest7aWithRawResponse:
        return AsyncYolkenTest7aWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncYolkenTest7aWithStreamedResponse:
        return AsyncYolkenTest7aWithStreamedResponse(self)
...
class YolkenTest7aWithRawResponse:
    _client: YolkenTest7a

    def __init__(self, client: YolkenTest7a) -> None:
        self._client = client
...
class AsyncYolkenTest7aWithRawResponse:
    _client: AsyncYolkenTest7a

    def __init__(self, client: AsyncYolkenTest7a) -> None:
        self._client = client
...
class YolkenTest7aWithStreamedResponse:
    _client: YolkenTest7a
...
class AsyncYolkenTest7aWithStreamedResponse:
    _client: AsyncYolkenTest7a
